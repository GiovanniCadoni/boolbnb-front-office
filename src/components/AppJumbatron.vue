...
<template>
    <div class="background">
        ...
        <div class="ms_container d-flex justify-content-center align-items-center gap-3 py-2">
            ...
            <router-link :to="{ name: 'research' }" class="nav-link"><button
                    class="btn rounded-4 btn-sm button-red d-lg-none px-4"><i
                        class="fa-solid fa-magnifying-glass"></i></button></router-link>
            <router-link :to="{ name: 'research' }" class="nav-link"><button
                    class="btn rounded-4 d-none d-lg-block button-red px-4"><i
                        class="fa-solid fa-magnifying-glass"></i></button></router-link>
        </div>
